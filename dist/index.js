...
// dist/pkg/common/index-e66f0a38.js
...
var react_production_min = createCommonjsModule(function(module, exports) {
  ...
  function J2(a, b2, c2) {
    ...
    return {$$typeof: n2, type: a, key: k2, ref: h2, props: d2, _owner: G3.current};
  }
  function K2(a, b2) {
  ...
  function O2(a, b2, c2, e2, d2) {
    ...
    if (h2)
      return h2 = a, d2 = d2(h2), a = e2 === "" ? "." + N3(h2, 0) : e2, Array.isArray(d2) ? (c2 = "", a != null && (c2 = a.replace(M3, "$&/") + "/"), O2(d2, b2, c2, "", function(a2) {
        return a2;
      })) : d2 != null && (L2(d2) && (d2 = K2(d2, c2 + (!d2.key || h2 && h2.key === d2.key ? "" : ("" + d2.key).replace(M3, "$&/") + "/") + a)), b2.push(d2)), 1;
    h2 = 0;
    e2 = e2 === "" ? "." : e2 + ":";
    if (Array.isArray(a))
      ...
      for (a = f2.call(a), g2 = 0; !(k2 = a.next()).done; )
        k2 = k2.value, f2 = e2 + N3(k2, g2++), h2 += O2(k2, b2, c2, f2, d2);
    else if (k2 === "object")
  ...
  exports.Children = {map: P3, forEach: function(a, b2, c2) {
    P3(a, function() {
  ...
  exports.memo = function(a, b2) {
    return {$$typeof: u2, type: a, compare: b2 === void 0 ? null : b2};
  };
  ...
  exports.useImperativeHandle = function(a, b2, c2) {
    return S3().useImperativeHandle(a, b2, c2);
  };
...
var scheduler_production_min = createCommonjsModule(function(module, exports) {
  ...
  if (typeof window === "undefined" || typeof MessageChannel !== "function") {
    ...
    var x = window.setTimeout, y3 = window.clearTimeout;
        ...
        a:
          for (var d2 = 0, e2 = a.length; d2 < e2; ) {
            ...
            if (n2 !== void 0 && 0 > I3(n2, c2))
              r2 !== void 0 && 0 > I3(r2, n2) ? (a[d2] = r2, a[v2] = c2, d2 = v2) : (a[d2] = n2, a[m2] = c2, d2 = m2);
  ...
  exports.unstable_scheduleCallback = function(a, b2, c2) {
    ...
    e2 = c2 + e2;
    a = {id: N3++, callback: b2, priorityLevel: a, startTime: c2, expirationTime: e2, sortIndex: -1};
    c2 > d2 ? (a.sortIndex = c2, H3(M3, a), J2(L2) === null && a === J2(M3) && (S3 ? h2() : S3 = true, g2(U3, c2 - d2))) : (a.sortIndex = e2, H3(L2, a), R2 || Q2 || (R2 = true, f2(V3)));
    return a;
  };
...
function stylis_min(W3) {
  function M3(d2, c2, e2, h2, a) {
    for (var m2 = 0, b2 = 0, v2 = 0, n2 = 0, q2, g2, x = 0, K2 = 0, k2, u2 = k2 = q2 = 0, l2 = 0, r2 = 0, I3 = 0, t2 = 0, B4 = e2.length, J2 = B4 - 1, y3, f2 = "", p2 = "", F4 = "", G4 = "", C2; l2 < B4; ) {
      g2 = e2.charCodeAt(l2);
      l2 === J2 && b2 + n2 + v2 + m2 !== 0 && (b2 !== 0 && (g2 = b2 === 47 ? 10 : 47), n2 = v2 = m2 = 0, B4++, J2++);
      if (b2 + n2 + v2 + m2 === 0) {
        if (l2 === J2 && (0 < r2 && (f2 = f2.replace(N3, "")), 0 < f2.trim().length)) {
          switch (g2) {
            case 32:
            case 9:
            case 59:
        ...
        switch (g2) {
          case 123:
            ...
            switch (q2) {
              case 64:
                ...
                k2 = M3(c2, r2, k2, g2, a + 1);
                t2 = k2.length;
                0 < A2 && (r2 = X3(O2, f2, I3), C2 = H3(3, k2, r2, c2, D3, z2, t2, g2, a, h2), f2 = r2.join(""), C2 !== void 0 && (t2 = (k2 = C2.trim()).length) === 0 && (g2 = 0, k2 = ""));
                if (0 < t2)
                  switch (g2) {
                    case 115:
                ...
                break;
              default:
                k2 = M3(c2, X3(c2, f2, I3), k2, h2, a + 1);
            }
            F4 += k2;
            k2 = I3 = r2 = u2 = q2 = 0;
            f2 = "";
          ...
          case 125:
          case 59:
            f2 = (0 < r2 ? f2.replace(N3, "") : f2).trim();
            if (1 < (t2 = f2.length))
              switch (u2 === 0 && (q2 = f2.charCodeAt(0), q2 === 45 || 96 < q2 && 123 > q2) && (t2 = (f2 = f2.replace(" ", ":")).length), 0 < A2 && (C2 = H3(1, f2, c2, d2, D3, z2, p2.length, h2, a, h2)) !== void 0 && (t2 = (f2 = C2.trim()).length) === 0 && (f2 = "\0\0"), q2 = f2.charCodeAt(0), g2 = f2.charCodeAt(1), q2) {
                case 0:
                  break;
                case 64:
                  if (g2 === 105 || g2 === 99) {
                ...
                default:
                  f2.charCodeAt(t2 - 1) !== 58 && (p2 += P3(f2, q2, g2, f2.charCodeAt(2)));
              }
            I3 = r2 = u2 = q2 = 0;
            f2 = "";
            g2 = e2.charCodeAt(++l2);
      ...
      switch (g2) {
        ...
        case 10:
          ...
          0 < A2 * Y3 && H3(0, f2, c2, d2, D3, z2, p2.length, h2, a, h2);
          z2 = 1;
          D3++;
          break;
        case 59:
        ...
        default:
          ...
          switch (g2) {
            ...
            case 11:
              ...
              break;
            case 38:
              n2 + b2 + m2 === 0 && (r2 = I3 = 1, y3 = "\f" + y3);
              break;
            case 108:
              if (n2 + b2 + m2 + E2 === 0 && 0 < u2)
                switch (l2 - u2) {
                  case 2:
                    x === 112 && e2.charCodeAt(l2 - 3) === 58 && (E2 = x);
                  case 8:
                    K2 === 111 && (E2 = K2);
                }
              break;
              ...
              if (!(0 < n2 + m2 + v2))
                switch (b2) {
                  case 0:
                    ...
                    break;
                  case 42:
                    g2 === 47 && x === 42 && t2 + 2 !== l2 && (e2.charCodeAt(t2 + 2) === 33 && (p2 += e2.substring(t2, l2 + 1)), y3 = "", b2 = 0);
                }
          }
          b2 === 0 && (f2 += y3);
      }
    ...
    if (0 < t2) {
      r2 = c2;
      if (0 < A2 && (C2 = H3(2, p2, r2, d2, D3, z2, t2, h2, a, h2), C2 !== void 0 && (p2 = C2).length === 0))
        return G4 + p2 + F4;
      p2 = r2.join(",") + "{" + p2 + "}";
      if (w2 * E2 !== 0) {
        w2 !== 2 || L2(p2, 2) || (E2 = 0);
  ...
  function P3(d2, c2, e2, h2) {
    ...
    switch (m2) {
      ...
      case 953:
        if (la2.test(d2) === true)
          return (b2 = d2.substring(d2.indexOf(":") + 1)).charCodeAt(0) === 115 ? P3(d2.replace("stretch", "fill-available"), c2, e2, h2).replace(":fill-available", ":stretch") : a.replace(b2, "-webkit-" + b2) + a.replace(b2, "-moz-" + b2.replace("fill-", "")) + a;
        break;
      case 962:
  ...
  function H3(d2, c2, e2, h2, a, m2, b2, v2, n2, q2) {
    for (var g2 = 0, x = c2, w3; g2 < A2; ++g2) {
      switch (w3 = S3[g2].call(B3, d2, x, e2, h2, a, m2, b2, v2, n2, q2)) {
        case void 0:
        case false:
        case true:
        case null:
  ...
  function B3(d2, c2) {
    ...
    var a = M3(O2, e2, c2, 0, 0);
    0 < A2 && (h2 = H3(-2, a, e2, e2, D3, z2, a.length, 0, 0, 0), h2 !== void 0 && (a = h2));
    V3 = "";
    E2 = 0;
    z2 = D3 = 1;
    return a;
  }
  var ca2 = /^\0+/g, N3 = /[\0\r\f]/g, aa = /: */g, ka2 = /zoo|gra/, ma2 = /([,: ])(transform)/g, ia2 = /,\r+?/g, F3 = /([\t\r\n ])*\f?&/g, fa2 = /@(k\w+)\s*(\S*)\s*/, Q2 = /::(place)/g, ha2 = /:(read-only)/g, G3 = /[svh]\w+-[tblr]{2}/, da2 = /\(\s*(.*)\s*\)/g, oa2 = /([\s\S]*?);/g, ba2 = /-self|flex-/g, na2 = /[^]*?(:[rp][el]a[\w-]+)[^]*/, la2 = /stretch|:\s*\w+\-(?:conte|avail)/, ja2 = /([^-])(image-set\()/, z2 = 1, D3 = 1, E2 = 0, w2 = 1, O2 = [], S3 = [], A2 = 0, R2 = null, Y3 = 0, V3 = "";
  B3.use = T3;
  B3.set = U3;
  W3 !== void 0 && U3(W3);
  return B3;
...
var g$2 = function(e2, t2) {
  for (var n2 = [e2[0]], r2 = 0, o = t2.length; r2 < o; r2 += 1)
    n2.push(t2[r2], e2[r2 + 1]);
  return n2;
};
var S2 = function(t2) {
  return t2 !== null && typeof t2 == "object" && (t2.toString ? t2.toString() : Object.prototype.toString.call(t2)) === "[object Object]" && !reactIs.typeOf(t2);
};
...
var A$2 = typeof process != "undefined" && process.env.SC_ATTR || "data-styled";
...
var B$1 = function(e2) {
  ...
  for (; x$2.has(V2); )
    V2++;
  var t2 = V2++;
  return k$2.set(e2, t2), x$2.set(t2, e2), t2;
};
var M2 = function(e2) {
  return x$2.get(e2);
};
var z$2 = function(e2, t2) {
  k$2.set(e2, t2), x$2.set(t2, e2);
};
var L = "style[" + A$2 + '][data-styled-version="5.3.0"]';
var G$1 = new RegExp("^" + A$2 + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)');
var F$1 = function(e2, t2, n2) {
  for (var r2, o = n2.split(","), i = 0, s = o.length; i < s; i++)
    (r2 = o[i]) && e2.registerName(t2, r2);
};
var Y2 = function(e2, t2) {
  for (var n2 = t2.innerHTML.split("/*!sc*/\n"), r2 = [], o = 0, i = n2.length; o < i; o++) {
    ...
    if (s) {
      ...
      if (a) {
        ...
        c2 !== 0 && (z$2(u2, c2), F$1(e2, u2, a[3]), e2.getTag().insertRules(c2, r2)), r2.length = 0;
      } else
        r2.push(s);
    }
  }
...
var H$1 = function(e2) {
  var t2 = document.head, n2 = e2 || t2, r2 = document.createElement("style"), o = function(e3) {
    for (var t3 = e3.childNodes, n3 = t3.length; n3 >= 0; n3--) {
      var r3 = t3[n3];
      if (r3 && r3.nodeType === 1 && r3.hasAttribute(A$2))
        return r3;
    }
  }(n2), i = o !== void 0 ? o.nextSibling : null;
  r2.setAttribute(A$2, "active"), r2.setAttribute("data-styled-version", "5.3.0");
  var s = q$2();
...
var Z2 = function() {
  function e2(e3, t3, n2) {
    e3 === void 0 && (e3 = E$1), t3 === void 0 && (t3 = {}), this.options = v$2({}, X2, {}, e3), this.gs = t3, this.names = new Map(n2), !this.options.isServer && I$1 && J && (J = false, function(e4) {
      for (var t4 = document.querySelectorAll(L), n3 = 0, r2 = t4.length; n3 < r2; n3++) {
        var o = t4[n3];
        o && o.getAttribute(A$2) !== "active" && (Y2(e4, o), o.parentNode && o.parentNode.removeChild(o));
      }
    }(this));
  }
  ...
  return t2.reconstructWithOptions = function(t3, n2) {
    return n2 === void 0 && (n2 = true), new e2(v$2({}, this.options, {}, t3), this.gs, n2 && this.names || void 0);
  }, t2.allocateGSInstance = function(e3) {
    return this.gs[e3] = (this.gs[e3] || 0) + 1;
  }, t2.getTag = function() {
    return this.tag || (this.tag = (n2 = (t3 = this.options).isServer, r2 = t3.useCSSOMInjection, o = t3.target, e3 = n2 ? new U2(o) : r2 ? new $(o) : new W2(o), new T2(e3)));
    var e3, t3, n2, r2, o;
...
var ie2 = function() {
  function e2(e3, t2, n2) {
    this.rules = e3, this.staticRulesId = "", this.isStatic = (n2 === void 0 || n2.isStatic) && re2(e3), this.componentId = t2, this.baseHash = te2(oe2, t2), this.baseStyle = n2, Z2.registerId(t2);
  }
  return e2.prototype.generateAndInjectStyles = function(e3, t2, n2) {
    ...
    if (this.baseStyle && o.push(this.baseStyle.generateAndInjectStyles(e3, t2, n2)), this.isStatic && !n2.hash)
      if (this.staticRulesId && t2.hasNameForId(r2, this.staticRulesId))
        ...
        var i = Ne2(this.rules, e3, t2, n2).join(""), s = ee2(te2(this.baseHash, i.length) >>> 0);
      ...
      for (var c2 = this.rules.length, u2 = te2(this.baseHash, n2.hash), l2 = "", d2 = 0; d2 < c2; d2++) {
        var h2 = this.rules[d2];
        if (typeof h2 == "string")
          l2 += h2, false;
        else if (h2) {
          var p2 = Ne2(h2, e3, t2, n2), f2 = Array.isArray(p2) ? p2.join("") : p2;
          u2 = te2(u2, f2 + d2), l2 += f2;
        }
      }
      if (l2) {
        var m2 = ee2(u2 >>> 0);
        if (!t2.hasNameForId(r2, m2)) {
          var y3 = n2(l2, "." + m2, void 0, r2);
          t2.insertRules(r2, m2, y3);
        }
        o.push(m2);
      }
    }
...
var ae2 = [":", "[", ".", "#"];
function ce2(e2) {
  var t2, n2, r2, o, i = e2 === void 0 ? E$1 : e2, s = i.options, a = s === void 0 ? E$1 : s, c2 = i.plugins, u2 = c2 === void 0 ? w$2 : c2, l2 = new stylis_min(a), d2 = [], h2 = function(e3) {
    function t3(t4) {
      if (t4)
        try {
          e3(t4 + "}");
    ...
    return function(n3, r3, o2, i2, s2, a2, c3, u3, l3, d3) {
      switch (n3) {
        case 1:
    ...
    return r3 === 0 && ae2.indexOf(i2[n2.length]) !== -1 || i2.match(o) ? e3 : "." + t2;
  };
  function m2(e3, i2, s2, a2) {
    a2 === void 0 && (a2 = "&");
    var c3 = e3.replace(se2, ""), u3 = i2 && s2 ? s2 + " " + i2 + " { " + c3 + " }" : c3;
    return t2 = a2, n2 = i2, r2 = new RegExp("\\" + n2 + "\\b", "g"), o = new RegExp("(\\" + n2 + "\\b){2,}"), l2(s2 || !i2 ? "" : i2, u3);
  }
  return l2.use([].concat(u2, [function(e3, t3, o2) {
    ...
    return t3.name || j(15), te2(e3, t3.name);
  }, 5381).toString() : "", m2;
}
...
var ve2 = function() {
  ...
  return e2.prototype.getName = function(e3) {
    return e3 === void 0 && (e3 = pe2), this.name + e3.hash;
  }, e2;
}();
var ge2 = /([A-Z])/;
var Se2 = /([A-Z])/g;
...
function be2(e2) {
  return ge2.test(e2) ? e2.replace(Se2, Ee2).replace(we2, "-ms-") : e2;
}
var _e = function(e2) {
  return e2 == null || e2 === false || e2 === "";
};
function Ne2(e2, n2, r2, o) {
  if (Array.isArray(e2)) {
    for (var i, s = [], a = 0, c2 = e2.length; a < c2; a += 1)
      (i = Ne2(e2[a], n2, r2, o)) !== "" && (Array.isArray(i) ? s.push.apply(s, i) : s.push(i));
    return s;
  }
  if (_e(e2))
    return "";
  ...
  if (b$2(e2)) {
    if (typeof (l2 = e2) != "function" || l2.prototype && l2.prototype.isReactComponent || !n2)
      return e2;
    var u2 = e2(n2);
    return Ne2(u2, n2, r2, o);
  }
  var l2;
  return e2 instanceof ve2 ? r2 ? (e2.inject(r2, o), e2.getName(o)) : e2 : S2(e2) ? function e3(t2, n3) {
    var r3, o2, i2 = [];
    for (var s2 in t2)
      t2.hasOwnProperty(s2) && !_e(t2[s2]) && (S2(t2[s2]) ? i2.push.apply(i2, e3(t2[s2], s2)) : b$2(t2[s2]) ? i2.push(be2(s2) + ":", t2[s2], ";") : i2.push(be2(s2) + ": " + (r3 = s2, (o2 = t2[s2]) == null || typeof o2 == "boolean" || o2 === "" ? "" : typeof o2 != "number" || o2 === 0 || r3 in unitlessKeys ? String(o2).trim() : o2 + "px") + ";"));
...
function Ae2(e2) {
  for (var t2 = arguments.length, n2 = new Array(t2 > 1 ? t2 - 1 : 0), r2 = 1; r2 < t2; r2++)
    n2[r2 - 1] = arguments[r2];
  return b$2(e2) || S2(e2) ? Ne2(g$2(w$2, [e2].concat(n2))) : n2.length === 0 && e2.length === 1 && typeof e2[0] == "string" ? e2 : Ne2(g$2(e2, n2));
}
var Oe2 = function(e2, t2, n2) {
  return n2 === void 0 && (n2 = E$1), e2.theme !== n2.theme && e2.theme || t2 || n2.theme;
};
var Re2 = /[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g;
var De2 = /(^-|-$)/g;
function je2(e2) {
...
function Be2(e2, t2, n2) {
  var r2 = e2[n2];
  xe(t2) && xe(r2) ? Me2(r2, t2) : e2[n2] = t2;
}
function Me2(e2) {
  for (var t2 = arguments.length, n2 = new Array(t2 > 1 ? t2 - 1 : 0), r2 = 1; r2 < t2; r2++)
    n2[r2 - 1] = arguments[r2];
...
var Le2 = ze.Consumer;
var Fe2 = {};
function Ye2(e2, t2, n2) {
  var o = N2(e2), s = !ke2(e2), a = t2.attrs, c2 = a === void 0 ? w$2 : a, d2 = t2.componentId, h2 = d2 === void 0 ? function(e3, t3) {
    var n3 = typeof e3 != "string" ? "sc" : je2(e3);
    Fe2[n3] = (Fe2[n3] || 0) + 1;
    var r2 = n3 + "-" + Te2("5.3.0" + n3 + Fe2[n3]);
    return t3 ? t3 + "-" + r2 : r2;
  }(t2.displayName, t2.parentComponentId) : d2, p2 = t2.displayName, f2 = p2 === void 0 ? function(e3) {
    return ke2(e3) ? "styled." + e3 : "Styled(" + _(e3) + ")";
  }(e2) : p2, g2 = t2.displayName && t2.componentId ? je2(t2.displayName) + "-" + t2.componentId : t2.componentId || h2, S3 = o && e2.attrs ? Array.prototype.concat(e2.attrs, c2).filter(Boolean) : c2, A2 = t2.shouldForwardProp;
  ...
  var C2, I3 = new ie2(n2, g2, o ? e2.componentStyle : void 0), P3 = I3.isStatic && c2.length === 0, O2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      var o2 = e4.attrs, s2 = e4.componentStyle, a2 = e4.defaultProps, c3 = e4.foldedComponentIds, d3 = e4.shouldForwardProp, h3 = e4.styledComponentId, p3 = e4.target;
      var f3 = function(e5, t5, n4) {
        e5 === void 0 && (e5 = E$1);
        var r3 = v$2({}, t5, {theme: e5}), o3 = {};
        return n4.forEach(function(e6) {
          var t6, n5, i, s3 = e6;
          for (t6 in b$2(s3) && (s3 = s3(r3)), s3)
            r3[t6] = o3[t6] = t6 === "className" ? (n5 = o3[t6], i = s3[t6], n5 && i ? n5 + " " + i : n5 || i) : s3[t6];
        }), [r3, o3];
      }(Oe2(t4, react.useContext(ze), a2) || E$1, t4, o2), y3 = f3[0], g3 = f3[1], S4 = function(e5, t5, n4, r3) {
        var o3 = fe2(), i = me2(), s3 = t5 ? e5.generateAndInjectStyles(E$1, o3, i) : e5.generateAndInjectStyles(n4, o3, i);
        return s3;
      }(s2, r2, y3), w2 = n3, _2 = g3.$as || t4.$as || g3.as || t4.as || p3, N3 = ke2(_2), A3 = g3 !== t4 ? v$2({}, t4, {}, g3) : t4, C3 = {};
      for (var I4 in A3)
        I4[0] !== "$" && I4 !== "as" && (I4 === "forwardedAs" ? C3.as = A3[I4] : (d3 ? d3(I4, index, _2) : !N3 || index(I4)) && (C3[I4] = A3[I4]));
      return t4.style && g3.style !== t4.style && (C3.style = v$2({}, t4.style, {}, g3.style)), C3.className = Array.prototype.concat(c3, h3, S4 !== h3 ? S4 : null, t4.className, g3.className).filter(Boolean).join(" "), C3.ref = w2, react.createElement(_2, C3);
    }(C2, e3, t3, P3);
  };
  return O2.displayName = f2, (C2 = react.forwardRef(O2)).attrs = S3, C2.componentStyle = I3, C2.displayName = f2, C2.shouldForwardProp = A2, C2.foldedComponentIds = o ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : w$2, C2.styledComponentId = g2, C2.target = o ? e2.target : e2, C2.withComponent = function(e3) {
    var r2 = t2.componentId, o2 = function(e4, t3) {
      ...
      return o3;
    }(t2, ["componentId"]), i = r2 && r2 + "-" + (ke2(e3) ? e3 : je2(_(e3)));
    return Ye2(e3, v$2({}, o2, {attrs: S3, componentId: i}), n2);
  }, Object.defineProperty(C2, "defaultProps", {get: function() {
    return this._foldedDefaultProps;
  }, set: function(t3) {
    this._foldedDefaultProps = o ? Me2({}, e2.defaultProps, t3) : t3;
...
var qe2 = function(e2) {
  return function e3(t2, r2, o) {
    if (o === void 0 && (o = E$1), !reactIs.isValidElementType(r2))
      return j(1, String(r2));
    var i = function() {
      return t2(r2, o, Ae2.apply(void 0, arguments));
    };
...
var indexByDay = Object.entries(daysOfTheWeek).reduce((map, [index2, day]) => {
  return {...map, [day]: Number(index2)};
}, {});
var makeWeekdays = (startDate, logs) => {
  const weekday = format(startDate, "eeee");
  const todayIndex = indexByDay[weekday];
  return Object.entries(indexByDay).reduce((days, [weekday2, index2]) => {
    const date = add(startDate, {
      days: index2 - todayIndex
    });
...
var DateContext = createContext(void 0);
var DateHandlersContext = createContext(void 0);
function DateProvider({children}) {
  ...
  const setFeeling = (mood, descriptors, date) => {
    ...
    const feelings = descriptors.reduce((acc, d2) => ({...acc, [d2]: mood}), prevFeelings);
    setDailyLogs({
      ...dailyLogs,
      [formattedDate]: {
        ...prevLog,
...
var StyledDay = styled_components_default.div`
  .mood-panel {
    display: flex;
...
`;
var StyledMoodBtn = styled_components_default.button`
  padding: 3px;
...
function Day({day, setMood, setFeeling, expungeFeeling, ...defaultProps}) {
  ...
  const handleDescriptorSubmit = (e2) => {
    e2.preventDefault();
...
// dist/hooks/useScreenWidth.js
var useScreenWidth_default = () => {
...
// dist/Week.js
var StyledWeek = styled_components_default.div`
  grid-area: base;
  display: grid;
  grid-template-rows: auto auto 1fr;
`;
function Week({month, year, ...props}) {
  const {incrementWeek, decrementWeek} = useDateHandlers();
  const width = useScreenWidth_default();
...
// dist/App.js
var StyledApp = styled_components_default.div`
  display: grid;
  min-height: 100vh;
...
`;
var indexByDay2 = Object.entries(daysOfTheWeek).reduce((map, [index2, day]) => {
  return {...map, [day]: Number(index2)};
}, {});
var makePrompt = (todayIndex) => {
  if (todayIndex <= 2)
...
function App({}) {
  ...
  const dayIndex = indexByDay2[weekday];
...
react_dom_default.render(/* @__PURE__ */ react.createElement(react.StrictMode, null, /* @__PURE__ */ react.createElement(DateProvider, null, /* @__PURE__ */ react.createElement(App_default, null))), document.getElementById("root"));
if (void 0) {
  (void 0).accept();
}
