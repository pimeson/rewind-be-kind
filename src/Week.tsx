  ...
  return (
    <StyledWeek className="px-6 md:px-12 mb-5" {...props}>
      <div className="flex mx-1 justify-between">
        <button onClick={decrementWeek} className="text-blue-400 hover:text-gray-100 sm:w-32 px-3 font-extrabold tracking-tight hover:bg-blue-400 py-2 hover:shadow">
        ...
        <button onClick={incrementWeek} className="text-red-400 hover:text-gray-100 sm:w-32 px-3 font-extrabold tracking-tight hover:bg-red-400 py-2 hover:shadow">
